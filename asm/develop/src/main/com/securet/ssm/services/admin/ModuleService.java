...
@Service
@Controller
public class ModuleService extends SecureTService {
	...
	@Transactional
	public String saveServiceType(@Valid @ModelAttribute("formObject") Module formObject,BindingResult result,Model model){
		boolean createNew = (formObject.getModuleId()==0);//default is 0..
