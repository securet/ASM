...
public class SQLAppNotification extends com.mysema.query.sql.RelationalPathBase<SQLAppNotification> {
    ...
    public void addMetadata() {
        addMetadata(createdTimestamp, ColumnMetadata.named("createdTimestamp").withIndex(8).ofType(Types.TIMESTAMP).withSize(19));
        addMetadata(fromDate, ColumnMetadata.named("fromDate").withIndex(4).ofType(Types.TIMESTAMP).withSize(19).notNull());
        addMetadata(isAppUpdate, ColumnMetadata.named("isAppUpdate").withIndex(3).ofType(Types.BIT).withSize(1).notNull());
        addMetadata(lastUpdatedTimestamp, ColumnMetadata.named("lastUpdatedTimestamp").withIndex(9).ofType(Types.TIMESTAMP).withSize(19));
        ...
        addMetadata(thruDate, ColumnMetadata.named("thruDate").withIndex(5).ofType(Types.TIMESTAMP).withSize(19));
    }
