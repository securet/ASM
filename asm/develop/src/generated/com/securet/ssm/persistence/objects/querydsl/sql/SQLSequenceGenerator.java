...
public class SQLSequenceGenerator extends com.mysema.query.sql.RelationalPathBase<SQLSequenceGenerator> {
    ...
    public void addMetadata() {
        addMetadata(createdTimestamp, ColumnMetadata.named("createdTimestamp").withIndex(3).ofType(Types.TIMESTAMP).withSize(19));
        addMetadata(lastUpdatedTimestamp, ColumnMetadata.named("lastUpdatedTimestamp").withIndex(4).ofType(Types.TIMESTAMP).withSize(19));
