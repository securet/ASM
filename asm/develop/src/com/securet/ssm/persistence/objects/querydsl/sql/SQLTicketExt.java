...
public class SQLTicketExt extends com.mysema.query.sql.RelationalPathBase<SQLTicketExt> {
    ...
    public void addMetadata() {
        addMetadata(createdTimestamp, ColumnMetadata.named("createdTimestamp").withIndex(4).ofType(Types.TIMESTAMP));
        ...
        addMetadata(lastUpdatedTimestamp, ColumnMetadata.named("lastUpdatedTimestamp").withIndex(5).ofType(Types.TIMESTAMP));
