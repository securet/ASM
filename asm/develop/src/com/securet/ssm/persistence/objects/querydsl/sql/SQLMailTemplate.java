...
public class SQLMailTemplate extends com.mysema.query.sql.RelationalPathBase<SQLMailTemplate> {
    ...
    public void addMetadata() {
        ...
        addMetadata(createdTimestamp, ColumnMetadata.named("createdTimestamp").withIndex(7).ofType(Types.TIMESTAMP));
        addMetadata(from, ColumnMetadata.named("from").withIndex(2).ofType(Types.VARCHAR).withSize(255));
        addMetadata(lastUpdatedTimestamp, ColumnMetadata.named("lastUpdatedTimestamp").withIndex(8).ofType(Types.TIMESTAMP));
