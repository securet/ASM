...
public class SQLClientUserSite extends com.mysema.query.sql.RelationalPathBase<SQLClientUserSite> {
    ...
    public void addMetadata() {
        addMetadata(createdTimestamp, ColumnMetadata.named("createdTimestamp").withIndex(1).ofType(Types.TIMESTAMP));
        addMetadata(lastUpdatedTimestamp, ColumnMetadata.named("lastUpdatedTimestamp").withIndex(2).ofType(Types.TIMESTAMP));
