		...
		<div class="panel panel-primary">
			...
			<div class="panel-body reports">
				<div class="row marginleft0">
					...
					<div  class="col-md-8">
						<div class="col-md-12 placeholders roundbordersmall">
							...
							<div id="ticketCountByStatusAndServiceType"  style="height:468px;" data-value='<@compress single_line=true>${countByServiceTypeAndStatusString}</@compress>'> </div>
						</div>
					</div>
				</div>
				<div class="row marginleft0 margintop10">
					...
					<div id="vendorUserTicketCount" class="col-md-6 dashboardcol2" data-value='${countByVendorString}'>
						<div class="col-md-12 placeholders roundbordersmall">
					...
					<div id="clientUserTicketCount" class="col-md-6 dashboardcol2" data-value='${countByClientString}'>
						<div class="col-md-12 placeholders roundbordersmall">
							<h4>Tickets posted by Client User</h4>
							<table id="clientUserTicketCountTable" class="display table table-striped table-hover dt-responsive"  cellspacing="0">
						        <thead>
						            <tr>
						                <th>User Id</th>
						                <th>Tickets</th>
				...
				<div class="row marginleft0 margintop10">
					<div class="col-md-10 placeholders roundbordersmall">
						...
						<div class="margintop10">
							...
							<div class='col-md-3'><a href="javascript:void(0)" class="btn btn-primary" id="downloadReport"><i class="glyphicon glyphicon-download-alt"></i> Download</a></div>
						</div>	
					</div>						
				</div>
			</div>
